"""Parse ``tests/initial-data.json`` into DDD repositories for local bootstrap."""
...
from ddd.domain.record import Activity, Record, RecordTime, WeekStart
...
def apply_parsed_week_block(
    ...
    """Apply goals and records from one fixture week into DDD repositories."""
